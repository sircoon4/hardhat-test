...
async function main() {
    ...
    const contractAddress = "0xA3B4b8510D49613Ac944463418183e4B9678b1e2";
    ...
    result = await actionParserWithSigner.parseExploreAdventureBoss(serializedPayload);
    console.log("ExploreAdventureBoss result:");
    console.log(result);
    console.log();
}
